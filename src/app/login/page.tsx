...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  RefreshAccessTokenError: "Tu sesión expiró. Por favor volvé a iniciar sesión.",
  Default: "Ocurrió un error al iniciar sesión. Intentá nuevamente.",
}
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-[#1e3a5f] to-slate-900 p-4">
      <div className="bg-white rounded-2xl shadow-2xl p-10 w-full max-w-md">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-6 py-3.5 border border-gray-200 rounded-xl text-gray-700 font-medium hover:bg-gray-50 active:bg-gray-100 transition-colors shadow-sm"
        >
          <GoogleIcon />
